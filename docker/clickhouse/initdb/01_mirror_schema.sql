...
SELECT
    ...
    toDecimal64OrZero(JSONExtractRaw(rec, 'price'), 2) AS price,
...
SELECT
    ...
    toDecimal64OrZero(JSONExtractRaw(rec, 'total_amount'), 2) AS total_amount,
...
SELECT
    ...
    toDecimal64OrZero(JSONExtractRaw(rec, 'unit_price'), 2) AS unit_price,
    toDateTime64(JSONExtractInt(rec, 'created_at') / 1000000, 6) AS created_at,
    toDateTime64(JSONExtractInt(rec, 'updated_at') / 1000000, 6) AS updated_at,
    JSONExtractUInt(raw, 'ts_ms') AS ver,
    if(op = 'd', 1, 0) AS is_deleted
